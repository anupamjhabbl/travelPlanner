    ...
    Column(
        ...
        Column(
            ...
            ComposeTextView.TextView(
                text = stringResource(R.string.pv_last_updated),
            ...
            val termsSections = com.example.bbltripplanner.screens.user.myacount.entity.ProfileActionResourceMapper.getPrivacyVisibilitySections()
...
@Composable
private fun PrivacyVisibilityToolbar() {
    ...
    Row(
        ...
        Column(
            ...
            ComposeTextView.TitleTextView(
                text = stringResource(R.string.privacy_visbility_title),
                fontSize = 20.sp
            )
        }
    }
