...
class ExpenseNetwork(
    ...
    override suspend fun deleteExpense(tripId: String, expenseId: String): String? {
        return BaseResponse.processResponse { expenseClient.deleteExpense(tripId, expenseId) }
    }
}
