...
fun PrivacyPolicyScreen() {
    ...
    Column(
        ...
        Column(
            ...
            val privacySections = com.example.bbltripplanner.screens.user.myacount.entity.ProfileActionResourceMapper.getPrivacyPolicySections()
            privacySections.forEach { section ->
                PrivacySectionHeader(title = stringResource(id = section.titleRes))
                PrivacySectionBody(text = stringResource(id = section.descriptionRes))
            }
...
@Composable
private fun PrivacySectionBody(text: String) {
    val customColors = LocalCustomColors.current
    ComposeTextView.TextView(
        text = text,
        fontSize = 15.sp,
